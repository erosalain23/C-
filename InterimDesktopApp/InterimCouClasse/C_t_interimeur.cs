...
namespace InterimCouClasse
{
 ...
 public class C_t_interimeur
 {
  ...
  { }
  public C_t_interimeur(string nom_inte_, string prenom_inte_, string specialisation_, double bonus_sal_,DateTime date_naissance_)
  {
   nom_inte = nom_inte_;
   ...
   bonus_sal = bonus_sal_;
        ...
        public C_t_interimeur(int id_inte_, string nom_inte_, string prenom_inte_, string specialisation_, double bonus_sal_,DateTime date_naissance_)
   : this(nom_inte_, prenom_inte_, specialisation_, bonus_sal_,date_naissance_)
  {
   id_inte = id_inte_;
  }
  #endregion
