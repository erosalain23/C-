...
namespace Memory_Game
{
    public partial class frmGameEngine : Form
    {
        ...
        public frmGameEngine( string[] DataRetr)
        {
            ...
            //    Console.WriteLine(l);
            //Console.ReadLine();
            playerOne = bool.Parse(DataRetr[1]);
            pointsPlayerOne = int.Parse(DataRetr[2]);
            pointsPlayerTwo = int.Parse(DataRetr[3]);
            this.GameOver = false;
            AssignIconsToSquares(icons);//assigning icons to labels
        ...
        private void AssignIconsToSquares(List<string> iconsRetr)
        {
            //foreach (string l in iconsRetr)
            //    Console.WriteLine(l);
            //Console.ReadLine();
            //string[] proof = new string[64];
            Label label;
