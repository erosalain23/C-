...
namespace Carrosse
{
    ...
    {
        #region Arguments
        private MonRectangle_tournant _part0, _part1, _part2, _part3, _part4, _part5, _part6, _part7, _part8;
        ...
        {
            //this._part0 = new MonRectangle_tournant(hebergeur, xsg, ysg/2, longueur, hauteur, Alpha, Color.Brown, Color.White);
        ...
        public new void Bouger(int deplX, int deplY)
        {
            ...
            //this._part0.Bouger(deplX, deplY);
