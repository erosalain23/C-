    ...
    class MonCercle : MonPoint
    {
        ...
        public override void Afficher(IntPtr handle)
        {
            if (this.Visible)
            {
                ...
                gr.DrawEllipse(new Pen(this.Crayon, 2), this.X - this.Rayon, this.Y - this.Rayon, 2 * this.Rayon, 2 * this.Rayon);
            }
        }
        ...
        public override void Cacher(IntPtr handle)
        {
            ...
            gr.DrawEllipse(new Pen(this.Fond, 2), this.X - this.Rayon, this.Y - this.Rayon, 2 * this.Rayon, 2 * this.Rayon);
        }
        #endregion
    }
}
